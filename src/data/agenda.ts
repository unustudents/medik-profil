...
export const agendaEvents: AgendaEvent[] = [
  ...
  },
  {
    ...
    status: "Akan Datang",
    image:
      "https://images.unsplash.com/photo-1770106678115-ec9aa241cdf6?q=80&w=1171&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    content: `
            <p class="text-lg leading-relaxed text-slate-600 dark:text-slate-300 mb-6">
  ...
  },
  {
    ...
    status: "Akan Datang",
    image:
      "https://images.unsplash.com/photo-1770199782220-486adbf69941?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    content: `
            <p class="text-lg leading-relaxed text-slate-600 dark:text-slate-300 mb-6">
  ...
  // Ongoing Events (Sedang Berlangsung)
  {
    ...
    image:
      "https://images.unsplash.com/photo-1584515933487-779824d29309?ixlib=rb-4.0.3&auto=format&fit=crop&w=1470&q=80",
    content: `
            <p class="text-lg leading-relaxed text-slate-600 dark:text-slate-300 mb-6">
  ...
  },
  {
    ...
    status: "Sedang Berlangsung",
    image:
      "https://images.unsplash.com/photo-1581056771107-24ca5f033842?ixlib=rb-4.0.3&auto=format&fit=crop&w=1470&q=80",
    content: `
            <p class="text-lg leading-relaxed text-slate-600 dark:text-slate-300 mb-6">
  ...
  },
  {
    ...
    status: "Acara telah lewat",
    image:
      "https://lh3.googleusercontent.com/aida-public/AB6AXuCvNQtkl7Twntd4hKPx2JNanr6M0zbRCC3fiCkUwrtNowhjPTAhSyMw0Sls7J2f3FBfWtlXQF2mrzZjNFUmy1qdTMroqIyW91P5bbJEAMiGSp3xWBuDB0SSUm83FJiFA1kRZvU4i7i8BBg9mFi6qAGjDQV9c0NB-zqxPFXWv8bTF5Upw7gEHnHnRHwnAx3ZeFcg-R_QEdaJgT5vDIyIncx0zgvKRsHlJNzcNFITF4qos3imAzTU7fhmSTmZxcBPC2XkS-glly93NuY",
    content: `
            <p class="text-lg leading-relaxed text-slate-600 dark:text-slate-300 mb-6">
  ...
  },
  {
    ...
    status: "Acara telah lewat",
    image:
      "https://lh3.googleusercontent.com/aida-public/AB6AXuCcvGnr9Vx1lFSXeiu9nmW5s5r_quu0fe5szueFHkBZb3I2nC6mGlvu9Qi9Rc5LC78IGFpbpf0DZ7fKNpopseicqmlXFakAyVxsaloBvcAH9jet9YhNvFFl7jdaPJ32wUodv2vI5RuG6qOuTUrwt-_36t7OWuzjmote8R7e55zbbuA8BRD537nO_nml6it70WFnAzQy5Qq9Vqz1Y3PPa827hfFMXW58eN-jttNesUf4BEbllY_k8HL167up9Y2z7MGkY4YmBMpGucs",
    content: `
            <p class="text-lg leading-relaxed text-slate-600 dark:text-slate-300 mb-6">
  ...
  },
  {
    ...
    status: "Acara telah lewat",
    image:
      "https://images.unsplash.com/photo-1632053001859-99426f6323c6?ixlib=rb-4.0.3&auto=format&fit=crop&w=1470&q=80",
    content: `
            <p class="text-lg leading-relaxed text-slate-600 dark:text-slate-300 mb-6">
